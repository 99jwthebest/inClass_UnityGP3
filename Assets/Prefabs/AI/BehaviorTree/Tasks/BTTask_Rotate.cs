...
{
    [SerializeField] float angleDegree;
    [SerializeField] float acceptableRotation;
    ...
    protected override BTNodeResult Execute()
    {
        ...
        goalRotation = Quaternion.AngleAxis(angleDegree, Vector3.up) * owner.transform.rotation;
    ...
    {
        return Quaternion.Angle(goalRotation, owner.transform.rotation) < acceptableRotation;
    }
